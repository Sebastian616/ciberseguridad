...
def fuerza_bruta(texto_cifrado):
    """ esta funcioin realiza fuerza bruta sobre eñ texto cifrado"""
    ...
    for clave in espacio_claves:
        ...
        if lenguaje == "es":
            print(f"el texto decifrado es: {texto_plano}")
            print(f"la clave de descifrado es: {clave}")
            return

if __name__ == "__main__":

    texto_cifrado = input("introducir el texto cifrado: ").lower()
